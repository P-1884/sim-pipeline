#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Fri Jan 26 14:38:30 GMT 2024      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 1 --mpi=pmi2 --mem-per-cpu=102400 nice -n 10 /mnt/users/hollowayp/python11_env/bin/python3.11 Generate_gg_lens_population_largescale.py
